    ...
    return Scaffold(
        ...
        body: ListView(
          children: <Widget>[
            ...
            Image.memory(base64Decode(widget.productData.image) , height: 300,width: double.infinity,fit: BoxFit.cover,),
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: froyoFlatBtn('Add to Cart', ()async {
                              await HelperDatabase.helperDatabase.addItemCart(widget.productData.id, _quantity);
                              showDialog(context: context , builder: (c){
                                return AlertDialog(
                                  content: Text('success'),
                                );
                              });
                              Navigator.of(context).pushReplacementNamed('/AddProductPag');
                            }),
                          )
                        ],
                      ),
